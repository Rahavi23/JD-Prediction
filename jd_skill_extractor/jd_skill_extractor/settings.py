"""
Django settings for jd_skill_extractor project.
...
SECRET_KEY = 'django-insecure-yi(h%%h!q+39i7wgxtqg%+i%_5km7*i+&00jq+j+!385z0i7a2'
...
ROOT_URLCONF = 'jd_skill_extractor.urls'
...
WSGI_APPLICATION = 'jd_skill_extractor.wsgi.application'
